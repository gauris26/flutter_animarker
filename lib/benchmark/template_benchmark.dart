...
Float32x4 latLngtoFloat32x4(Vector3 vector3) => Float32x4(vector3.x, vector3.y, vector3.z, 0);
...
Float32x4 inverseLerp(Float32x4 min, Float32x4 max, Float32x4 delta, bool isEqualValue, Float32x4 value) {
